		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee Data",
									"targetURL": "#comemployeefempfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemployeefempfiori-display": {
								"semanticObject": "comemployeefempfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.employee.f.empfiori",
									"url": sap.ui.require.toUrl("com/employee/f/empfiori")
								}
							}
						}
					}
